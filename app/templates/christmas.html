...
<link rel="stylesheet" href="/static/c/images/main.css" type="text/css">

<script type="text/javascript" src="/static/c/images/viewport.js"></script>
<script type="text/javascript" src="/static/c/images/jquery-1.9.1-min.js"></script>
<script src="/static/c/images/jquery.min.js"></script>
<script src="/static/c/images/warterfall.js"></script>
<script>var gSound = '/static/c/images/christmas.mp3';</script>
		...
		function createFlowersSprite(number)
		{
			...
			this.createFlowerAnimation = function(){
				for(i=0;i<this.flowerCountsPerTime;i++)
				{
					...
					{
						this.flowerArr[i].src = '/static/c/images/'+this.flowerResArr[0][(parseInt(Math.random()*9)%9)];
					}else{
						this.flowerArr[i].src = '/static/c/images/'+this.flowerResArr[1][(parseInt(Math.random()*10)%10)];
					}
...
function switchsound()
{
	...
	{
		au.play();
		ai.src = "http://zt.house365.com/project/wh/weixin/web/20141212_weixiu//static/c/images/music_note_big.png";
...
function playbksound()
{
	...
	bg_htm = "<img id='sound_image' onclick='switchsound()' src='/static/c/images/music_note_big.png'>";
...
<body>
	<div class="wrapper">
		...
		<div class="animation1">
			...
			<div class="deer_group">
				<div class="pop1"></div>
				<div class="pop2"><div class="content_border"><img src="/static/c/images/desc_1.png" class="content_1"><?=$name?></div><img src="/static/c/images/desc_2.png" class="content_3"></div>
				<div class="deer"></div>
 ...
 <div id="sharemcover" onClick="document.getElementById('sharemcover').style.display='';" style=" display:none"><img src="http://img.ishangtong.com/bae/static/c/images/MgnnofmleM.png"></div>
 <div class="cardWrap">
...
width: 35px;
height: 35px;
background: url('http://apisimsim.duapp.com/index//static/c/images/play.png') no-repeat center center;
...
.btn_music.on {
    background-image: url("http://apisimsim.duapp.com/index//static/c/images/stop.png");
}
...
<div class="messageBox">
  ...
  id="bjid" onChange="doit()" name="bjid"   > 
	...
	<div id="preload" style="display:none" >
		<img src="/static/c/images/reindeer_2.png">
		<img src="/static/c/images/flower_1.png">
		<img src="/static/c/images/flower_2.png">
		<img src="/static/c/images/flower_3.png">
		<img src="/static/c/images/flower_4.png">
		<img src="/static/c/images/flower_5.png">
		<img src="/static/c/images/flower_6.png">
		<img src="/static/c/images/flower_7.png">
		<img src="/static/c/images/flower_8.png">
		<img src="/static/c/images/flower_9.png">
		<img src="/static/c/images/flower_10.png">
		<img src="/static/c/images/flower_11.png">
		<img src="/static/c/images/flower_12.png">
		<img src="/static/c/images/flower_13.png">
		<img src="/static/c/images/flower_14.png">
	</div>
   ...
   document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
        ...
        WeixinJSBridge.on('menu:share:appmessage', function (argv) {
            WeixinJSBridge.invoke('sendAppMessage', { 
                "img_url": "/static/c/images/reindeer_2.png",
                "img_width": "640",
                "img_height": "640",
